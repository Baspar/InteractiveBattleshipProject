...
class Grille{
	...
	/// \fn verifierCase(Coordonnees caseDepart, Coordonnees caseArrivee)
	...
	/// \fn verifierPlacement(Coordonnees caseDepart, Coordonnees caseArrivee)
	...
	/// \fn bool placementBateauValide(*Bateau bateau, Case caseDepart, Case caseArrivee)
	/// \brief vérifie le placement baeaut
	///
	/// \param bateau : bateau à placer sur la case
	/// \param caseDepart : case de départ sur laquelle nous placons le bateau
	/// \param caseArrivee : case d'arrivee sur laquelle nous placons le bateau
