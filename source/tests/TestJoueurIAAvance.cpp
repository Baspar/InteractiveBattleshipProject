...
int main(){
	cout << endl << endl << endl;
	JoueurIAAvance pbn("pôl_é_kockduhi");
	...
	JoueurIAAvance pbn2("Léauéclem",6,10,ar);
	...
	JoueurIAAvance pbn3("Bas ti 1 et Da mi 1",arm);
	...
	cout << endl << endl << endl;
	JoueurIAAvance pbn4("BasssssssssssssttttiennéVivi",8,12);
	...
	cout << "Voici la grille renvoyée par le placement bateau chez un JoueurIAAvance : " << endl;
	afficherGrille(gr);
	...
	JoueurIAAvance pbn6("DaméAnn",3,3,vec2);
	...
	JoueurIAAvance pbn7("jesaispasqui",vec3,arme);
	...
	JoueurIAAvance pbn8("jesaistout",7,6,vec4,armm);
