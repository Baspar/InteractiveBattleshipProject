...
int main(){
	cout << endl << endl << endl;
	PersonnageBNIA pbn("pôl_é_kockduhi");
	...
	PersonnageBNIA pbn2("Léauéclem",6,10,ar);
	...
	PersonnageBNIA pbn3("Bas ti 1 et Da mi 1",arm);
	...
	cout << endl << endl << endl;
	PersonnageBNIA pbn4("BasssssssssssssttttiennéVivi",8,12);
	...
	cout << "Voici la grille renvoyée par le placement bateau chez un PersonnageBNIA : " << endl;
	afficherGrille(gr);
	...
	PersonnageBNIA pbn6("DaméAnn",3,3,vec2);
	...
	PersonnageBNIA pbn7("jesaispasqui",vec3,arme);
	...
	PersonnageBNIA pbn8("jesaistout",7,6,vec4,armm);
