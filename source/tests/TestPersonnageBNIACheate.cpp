...
int main(){
	cout << endl << endl << endl;
	PersonnageBNIACheate pbn("pôl_é_kockduhi");
	...
	PersonnageBNIACheate pbn2("Léauéclem",6,10,ar);
	...
	PersonnageBNIACheate pbn3("Bas ti 1 et Da mi 1",arm);
	...
	cout << endl << endl << endl;
	PersonnageBNIACheate pbn4("BasssssssssssssttttiennéVivi",8,12);
	...
	PersonnageBNIACheate pbn5("Perso",vec);
	...
	cout << "Voici la grille renvoyée par le placement bateau chez un PersonnageBNIACheate : " << endl;
	afficherGrille(gr);
	...
	PersonnageBNIACheate pbn6("DaméAnn",3,3,vec2);
	...
	PersonnageBNIACheate pbn7("jesaispasqui",vec3,arme);
	...
	PersonnageBNIACheate pbn8("jesaistout",7,6,vec4,armm);
