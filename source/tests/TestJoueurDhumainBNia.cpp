...
int main(){
	cout << endl << endl << endl;
	JoueurDhumainBNia pbn("pôl_é_kockduhi");
	...
	JoueurDhumainBNia pbn2("Léauéclem",6,10,ar);
	...
	JoueurDhumainBNia pbn3("Bas ti 1 et Da mi 1",arm);
	...
	cout << endl << endl << endl;
	JoueurDhumainBNia pbn4("BasssssssssssssttttiennéVivi",8,12);
	...
	JoueurDhumainBNia pbn5("Perso",vec);
	...
	cout << "Voici la grille renvoyée par le placement bateau chez un JoueurDhumainBNia : " << endl;
	afficherGrille(gr);
	...
	JoueurDhumainBNia pbn6("DaméAnn",3,3,vec2);
	...
	JoueurDhumainBNia pbn7("jesaispasqui",vec3,arme);
	...
	JoueurDhumainBNia pbn8("jesaistout",7,6,vec4,armm);
